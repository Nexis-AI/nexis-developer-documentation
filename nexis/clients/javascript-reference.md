...
The `@NexisNetwork/web3.js` library is a package that has coverage over the
[Nexis JSON RPC API](/docs/rpc).

You can find the full documentation for the `@Nexisnetwork/web3.js` library
[here](https://Nexis-Network.github.io/Nexis-web3.js/).

## General

### Connection

[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/Connection.html)

Connection is used to interact with the [Nexis JSON RPC](/docs/rpc). You can
...
interact with any of the Nexis JSON RPC API.

#### Example Usage

```javascript
const web3 = require("@Nexisnetwork/web3.js");
...
[source generated docs](https://Nexis-Network.github.io/Nexis-web3.js/classes/Connection.html)
for the full list.

### Transaction

[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/Transaction.html)

A transaction is used to interact with programs on the Nexis blockchain. These
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/Keypair.html)

The keypair is used to create an account with a public key and secret key within
Nexis. You can either generate, generate from a seed, or create from a secret
key.

#### Example Usage

```javascript
const { Keypair } = require("@Nexisnetwork/web3.js");
...
Using `generate` generates a random Keypair for use as an account on Nexis.
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/PublicKey.html)

PublicKey is used throughout `@Nexisnetwork/web3.js` in transactions, keypairs, and
programs. You require publickey when listing each account in a transaction and
as a general identifier on Nexis.
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/SystemProgram.html)
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/Secp256k1Program.html)
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/Message.html)
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/Struct.html)
...
import { Struct } from "@Nexisnetwork/web3.js";
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/Enum.html)
...
```javascript
import { Enum } from "@Nexisnetwork/web3.js";
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/NonceAccount.html)
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/VoteAccount.html)
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/StakeProgram.html)

The StakeProgram facilitates staking NZT and delegating them to any validators
on the network. You can use StakeProgram to create a stake account, stake some
NZT, authorize accounts for withdrawal of your stake, deactivate your stake, and
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/Authorized.html)

Authorized is an object used when creating an authorized account for staking
within Nexis. You can designate a `staker` and `withdrawer` separately,
...
[Source Documentation](https://Nexis-Network.github.io/Nexis-web3.js/classes/Lockup.html)
