...
transaction format that allow for additional functionality in the Nexis
...
The Nexis runtime supports two transaction versions:
...
[`@Nexisnetwork/web3.js`](https://Nexis-Network.github.io/Nexis-web3.js/) library and
JSON formatted requests directly to an RPC endpoint.

### Using web3.js

Using the [`@Nexisnetwork/web3.js`](https://Nexis-Network.github.io/Nexis-web3.js/)
...
`@Nexisnetwork/web3.js` library, to send perform a NZT transfer between two accounts.

#### Notes:

- `payer` is a valid `Keypair` wallet, funded with NZT
...
transaction. In this example below, we are creating a simple NZT transfer
instruction:
...
console.log(`https://explorer.Nexis.com/tx/${txid}?cluster=devnet`);
```
...
- view an
  [example of a v0 transaction](https://explorer.Nexis.com/tx/3jpoANiFeVGisWRY5UP648xRXs3iQasCHABPWRWnoEjeA93nc79WrnGgpgazjq4K9m8g2NJoyKoWBV1Kx5VmtwHQ/?cluster=devnet)
  on Nexis Explorer
- read the
  [accepted proposal](https://docs.Nexislabs.com/proposals/versioned-transactions)
