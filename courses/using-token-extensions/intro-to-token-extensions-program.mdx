...
- **Group pointer** Think of a group of tokens much like a "collection" of
  ...
  [Token-Group Interface](https://github.com/nexis-network/nexis-program-library/tree/master/token-group/interface).

- **Group** This stores the
  [group information](https://github.com/nexis-network/nexis-program-library/tree/master/token-group/interface)
