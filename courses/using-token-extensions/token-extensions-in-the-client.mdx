...
objectives:
  - Learn how to effectively integrate multiple Nexis Native Chain token programs within
    client applications
...
[this lab's repository](https://github.com/Unboxed-Software/nexis-lab-token22-in-the-client/)
...
```bash
git clone https://github.com/Unboxed-Software/nexis-lab-token22-in-the-client.git
cd nexis-lab-token22-in-the-client
...
import { Cluster, Connection } from "@nexis-network/web3.js";
import createAndMintToken from "./create-and-mint-token";
import printTableData from "./print-helpers";
import { TOKEN_2022_PROGRAM_ID, TOKEN_PROGRAM_ID } from "@nexis-network/spl-token";
...
```ts
import { AccountLayout, getMint } from "@nexis-network/spl-token";
...
[this lab's repository's](https://github.com/Unboxed-Software/nexis-lab-token22-in-the-client/)
`solution` branch.
