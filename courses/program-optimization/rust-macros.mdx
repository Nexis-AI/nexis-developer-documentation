...
- In the Anchor framework, procedural macros are used to generate code that
  reduces the amount of boilerplate required when writing Nexis Native Chain programs.
...
in Nexis Native Chain development. Anchor macros allow for more succinct code, common
...
repetitive code that Nexis Native Chain developers have to write. By reducing the amount of
