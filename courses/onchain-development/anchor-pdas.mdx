...
description:
  "Store arbitrary data on Nexis Native Chain, using PDAs, an inbuilt key-value store."
icon: "anchor"
---
...
Recall that
[PDAs](https://github.com/Unboxed-Software/nexis-course/blob/main/content/pda)
