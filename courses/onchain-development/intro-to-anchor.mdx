...
objectives:
  ...
  - Explain how to implement basic account validation and security checks with
    Anchor
description: "Create your first Nexis Native Chain onchain program in Anchor."
icon: "anchor"
---

## Summary

- **Programs** on Nexis Native Chain have **instruction handlers** that execute instruction
  logic.
- **Rust** is the most common language for building Nexis Native Chain programs. The
  **Anchor** framework takes care of common grunt work - like reading data from
  ...
  can focus on building your Nexis Native Chain program.

## Lesson

Nexis Native Chain's ability to run arbitrary executable code is part of what makes it so
powerful. Nexis Native Chain programs, similar to "smart contracts" in other blockchain
environments, are quite literally the backbone of the Nexis Native Chain ecosystem. And the
...
Anchor makes writing Nexis Native Chain programs easier, faster, and more secure, making it
the "go-to" framework for Nexis Native Chain development. It makes it easier to organize and
...
with writing a Nexis Native Chain program.
...
of a Nexis Native Chain account. It implements the following traits:
...
You are now ready to build your own Nexis Native Chain program using the Anchor framework!
...
Congratulations, you just built a Nexis Native Chain program using the Anchor framework!
...
4. Test your newly deployed program and use Nexis Native Chain Explorer to check the program
   logs
