...
description: "Invoke other Nexis Native Chain programs from your Anchor app. "
icon: "anchor"
---
...
Anchor makes invoking other Nexis Native Chain programs easier, especially if the program
...
type: [`ProgramError`](https://docs.rs/nexis-program/latest/nexis_program/program_error/enum.ProgramError.html).
...
import { getAssociatedTokenAddress, getAccount } from "@nexis-network/spl-token"
...
You can run `npm install @nexis-network/spl-token --save-dev` if you don't have it
installed.
