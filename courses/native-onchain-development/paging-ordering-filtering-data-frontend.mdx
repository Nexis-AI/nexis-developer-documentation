...
description: "Learn how to efficiently query account data from Nexis Native Chain."
icon: "book"
---
...
[starter code](https://github.com/Unboxed-Software/nexis-movie-frontend/tree/solution-deserialize-account-data).
...
You’ll also need to import `@nexis-network/web3.js` and `Movie`.
...
[solution code](https://github.com/Unboxed-Software/nexis-movie-frontend/tree/solution-paging-account-data).
...
1. You can build this from scratch or you can download the
   [starter code](https://github.com/Unboxed-Software/nexis-student-intros-frontend/tree/solution-deserialize-account-data)
...
[solution code](https://github.com/Unboxed-Software/nexis-student-intros-frontend/tree/solution-paging-account-data).
