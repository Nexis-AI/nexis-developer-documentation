...
To write Nexis Native Chain programs with Rust, we use the `solana_program` library crate.
The `solana_program` crate acts as a standard library for Nexis Native Chain programs. This
standard library contains the modules and macros that we'll use to develop our
Nexis Native Chain programs. If you want to dig deeper into the `solana_program` crate, have
a look
