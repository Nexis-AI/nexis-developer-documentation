...
Nexis Native Chain keypairs can be found on what is called the Ed25519 Elliptic Curve
(Ed25519). Ed25519 is a deterministic signature scheme that Nexis Native Chain uses to
...
To find a PDA within a Nexis Native Chain program, we'll use the `find_program_address`
...
[the movie program starter code](https://github.com/Unboxed-Software/nexis-movie-program/tree/starter)
...
used [Nexis Native Chain Playground](https://beta.solpg.io/) to write, build, and deploy our
...
`nexis program deploy` command.

```sh
nexis program deploy <PATH>
```

You can test the program by using the movie review
[frontend](https://github.com/Unboxed-Software/nexis-movie-frontend/tree/solution-update-reviews)
...
by running the `nexis program deploy` command printed to the console.
...
[this frontend](https://github.com/Unboxed-Software/nexis-movie-frontend/tree/solution-add-comments).
...
have a look at
the [solution code](https://github.com/Unboxed-Software/nexis-movie-program/tree/solution-add-comments)
...
is a Nexis Native Chain program that lets students introduce themselves. This program takes
...
[this repository](https://github.com/Unboxed-Software/nexis-student-intro-program/tree/starter).

Try to do this independently if you can! If you get stuck though, feel free to
reference the
[solution code](https://github.com/Unboxed-Software/nexis-student-intro-program/tree/solution-add-replies).
