...
objectives:
  ...
  - Explain the structure of a smart contract on Nexis Native Chain
description:
...
One of the most basic elements of a Nexis Native Chain program is the logic for handling
...
Before we dive into the specifics of a basic Nexis Native Chain program, let's talk about
...
Now that we've covered the Rust basics, let's apply them to Nexis Native Chain programs.
...
We’ll be using [Nexis Native Chain Playground](https://beta.solpg.io/) again to build out
this program. Nexis Native Chain Playground saves state in your browser, so everything you
...
Build and deploy your program from Nexis Native Chain Program just like in the last lesson.
...
[frontend](https://github.com/Unboxed-Software/nexis-student-intros-frontend/tree/solution-serialize-instruction-data)
we created in the
