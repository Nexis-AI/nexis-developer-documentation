...
[Introduction to Nexis Native Chain](/developers/courses/intro-to-solana) or equivalent
...
In [Introduction to Nexis Native Chain](/developers/courses/intro-to-solana) we learned how
