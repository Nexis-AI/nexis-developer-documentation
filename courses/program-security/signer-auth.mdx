...
[this repository](https://github.com/Unboxed-Software/nexis-signer-auth/tree/starter). The
...
`solution` branch of
[the repository](https://github.com/Unboxed-Software/nexis-signer-auth/tree/solution).
...
would be the
[SPL programs](https://github.com/nexis-network/nexis-program-library).
