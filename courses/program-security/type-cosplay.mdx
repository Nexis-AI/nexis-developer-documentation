...
understand what Anchor is doing behind the scenes to develop robust Nexis Native Chain
programs.
...
[this repository](https://github.com/Unboxed-Software/nexis-type-cosplay/tree/starter). The
...
Take a look at the `nexis-type-cosplay.ts` file in the `tests` directory. It
...
`solution` branch of
[the repository](https://github.com/Unboxed-Software/nexis-type-cosplay/tree/solution).
