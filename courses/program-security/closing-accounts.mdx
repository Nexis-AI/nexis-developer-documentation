...
- The Nexis Native Chain runtime **garbage collects accounts** when they are no longer rent
...
account, thus triggering the Nexis Native Chain runtime to garbage collect the first
...
[following repo](https://github.com/Unboxed-Software/nexis-closing-accounts/tree/starter).
...
`solution` branch of
[the same repository](https://github.com/Unboxed-Software/nexis-closing-accounts/tree/solution).
