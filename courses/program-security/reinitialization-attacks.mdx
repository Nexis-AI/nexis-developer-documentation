...
[this repository](https://github.com/Unboxed-Software/nexis-reinitialization-attacks/tree/starter).
...
`solution` branch of
[this repository](https://github.com/Unboxed-Software/nexis-reinitialization-attacks/tree/solution).
