...
- The
  [**`create_program_address`**](https://docs.rs/nexis-program/latest/nexis_program/pubkey/struct.Pubkey.html#method.create_program_address)
  ...
  addresses.
- Using
  [**`find_program_address`**](https://docs.rs/nexis-program/latest/nexis_program/pubkey/struct.Pubkey.html#method.find_program_address)
...
valid PDA. The standard in Nexis Native Chain is to _always use the canonical bump_ when
...
[this repository](https://github.com/Unboxed-Software/nexis-bump-seed-canonicalization/tree/starter).
...
`solution` branch of
[the same repository](https://github.com/Unboxed-Software/nexis-bump-seed-canonicalization/tree/solution).
