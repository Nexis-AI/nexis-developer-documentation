...
objectives:
  ...
  - Safely and securely make a CPI from an Anchor program to an arbitrary
    non-anchor program
description: "How to safely invoke Nexis Native Chain programs from other Nexis Native Chain programs."
...
in a
[previous lesson](https://github.com/Unboxed-Software/nexis-course/blob/main/content/anchor-cpi)
...
architecture to how NFTs on Nexis Native Chain work: the SPL Token Program manages the token
...
[this repository](https://github.com/Unboxed-Software/nexis-arbitrary-cpi/tree/starter).
...
`solution` branch of
[the same repository](https://github.com/Unboxed-Software/nexis-arbitrary-cpi/tree/solution).
