...
- `metadata-pointer` extension: Adds two simple fields in the mint account
  ...
  token following the
  [Token-Metadata Interface](https://github.com/nexis-network/solana-program-library/tree/master/token-metadata/interface),
  and the authority to update this pointer.
- `metadata` extension: Adds the fields described in the
  [Token-Metadata Interface](https://github.com/nexis-network/solana-program-library/tree/master/token-metadata/)
...
- Copy the address and airdrop some devnet sol from
  [faucet.solana](https://faucet.nexis.network/).
