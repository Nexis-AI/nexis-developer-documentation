---
title: Create Transactions on the Nexis Native Chain Network
objectives:
  - Explain transactions
  - Explain transaction fees
  - Use `@nexis-network/web3.js` to send SOL
  - Use `@nexis-network/web3.js` to sign transactions
  - Use Nexis Native Chain Explorer to view transactions
description:
...
You can also use the Nexis Native Chain CLI command `solana airdrop 1` to get free test SOL
in your account when testing, whether locally or on devnet.

### Nexis Native Chain Explorer

![Nexis Native Chain Explorer set to Devnet](/public/assets/courses/unboxed/solana-explorer-devnet.png)
...
![Nexis Native Chain Explorer with details about a transaction](/public/assets/courses/unboxed/solana-explorer-transaction-overview.png)
...
- Can you find your transaction on https://explorer.nexis.network? Remember we are
