...
- **SOL** is the name of Nexis Native Chain’s native token. Each SOL is made from 1 billion
  **Lamports**.
...
SOL is Nexis Native Chain's 'native token' - this means SOL is used to pay transaction fees,
...
(for GBP), Nexis Native Chain apps typically transfer, spend, store, and handle SOL as
...
[Get some Devnet SOL](https://faucet.nexis.network/) and use the public key of your
