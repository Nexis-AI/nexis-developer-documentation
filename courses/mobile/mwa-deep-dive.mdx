...
completed the
[Basic Nexis Native Chain Mobile lesson](/content/courses/mobile/basic-solana-mobile), both
...
2. Install a
   [Devnet Nexis Native Chain dApp](https://github.com/Unboxed-Software/solana-react-native-counter.git)
...
[Introduction to Nexis Native Chain Mobile lab](/content/courses/mobile/intro-to-solana-mobile)
with two additions:
