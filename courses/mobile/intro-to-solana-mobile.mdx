...
and the
[Nexis Native Chain dApp Store](https://docs.solanamobile.com/getting-started/overview#solana-dapp-store).
...
[The Nexis Native Chain Mobile docs provide a nice list of packages](https://docs.solanamobile.com/react-native/setup)
...
- `@nexis-network-mobile/mobile-wallet-adapter-protocol-web3js`: A convenience wrapper
  ...
  from [@nexis-network/web3.js](https://github.com/nexis-network/solana-web3.js), such
