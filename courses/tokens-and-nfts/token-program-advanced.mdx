...
```typescript
import { burn } from "@nexis-network/spl-token";
```
...
```typescript
import { PublicKey, Transaction } from "@nexis-network/web3";
import { createBurnInstruction } from "@nexis-network/spl-token";
...
Nexis Native Chain Explorer. The `approve` function requires the following arguments:
...
```typescript
import { PublicKey, Transaction } from "@nexis-network/web3";
import { createApproveInstruction } from "@nexis-network/spl-token";
...
```typescript
import { revoke } from "@nexis-network/spl-token";
...
Nexis Native Chain Explorer. The `revoke` function requires the following arguments:
...
import { Connection, PublicKey, clusterApiUrl } from "@nexis-network/web3.js";
import { getOrCreateAssociatedTokenAccount, burn } from "@nexis-network/spl-token";
