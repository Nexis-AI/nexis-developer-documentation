...
You can also use the Nexis Native Chain CLI command `nexis airdrop 1` to get free test NZT
...
[Intro to Cryptography](/content/courses/intro-to-nexis-ai/intro-to-cryptography).
